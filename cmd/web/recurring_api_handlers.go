...
func (app *application) listRecurringAPI(w http.ResponseWriter, r *http.Request) {
	r.ParseForm()
	...
	recurringList, err := app.services.Recurring.ListRecurring(
		&models.Filter{
			Query:    filterQuery,
			SortBy:   sort,
	...
	response := envelope{
		"recurringSketches": recurringList.Recurring,
		"meta":              recurringList.Metadata,
	}
